...
const events = [
  { day: 6, title: 'Launch Party', time: '6 PM - 9 PM', admission: 'Free', description: 'In no particular order: painting (v), paintings (n), puppets, popcorn, bubbly. Vinyl spun by Alison Matney of Bull City Vintage.', link: null },
  ...
  { day: 10, title: 'In TRUE Form Podcast LIVE', time: '8 PM - 9 PM', admission: 'Free', description: 'Live recording of In TRUE Form podcast with host Corey Truesdale and special guest Amos Cooper Jr.', link: 'https://www.instagram.com/intrueform_' },
  ...
  { day: 15, title: "Saints & Ain'ts: A Good Word", time: '5 PM - 7 PM', admission: '$7', description: 'An immersive pop-up performance experience inspired by the stage play created by Dasan Ahanu.', link: 'https://agoodwordpopup.eventbrite.com' },
