...
const events = [
  ...
  { day: 22, title: 'Black Sound Space Jam', time: '7 PM - 9 PM', admission: 'Free', description: 'Improvisation jam session for Black sound artists to come and bend time with each other. Bring your instrument and the gear you need to participate. All acoustic, vocal, and electronic styles welcome. Come get loose and build an impermanent, sonic Black world together. $10 Suggested Donation.', link: null },
